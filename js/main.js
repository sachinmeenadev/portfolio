(function ($) {
    ...
    $('#element').typed({
        strings: ["Project Consultant", "Web Designer", "Web App Developer", "UI, UX Designer", "Graphic Designer", "Android App Developer", "Team Leader"],
        typeSpeed: 0,
        loop: true,
        startDelay: 500,
        backDelay: 3000,
    ...
    $('.blog-block, .menu-item.blog').on('click', function () {
        var postUrl = 'http://blog.sachinkumarmeena.co.in/';
    ...
    function init() {
        ...
        var marker = new google.maps.Marker({
            position: new google.maps.LatLng(26.9124, 75.7873),
            map: map,
            icon: image,
            draggable: true,
